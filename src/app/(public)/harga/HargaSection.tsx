    ...
    <section className="services-section" id="harga">
      <div className="container">
        <div className="section-header scroll-reveal">
          ...
          <h2 className="section-title">Pilihan Paket Harga</h2>
          <p className="section-subtitle">
            Pilih paket harga terbaik yang sesuai dengan skala kebutuhan bisnis Anda. Semua paket memiliki garansi dan responsive.
          </p>
        </div>
        ...
        <div className="services-grid">
          ...
          <div className="service-card scroll-reveal reveal-delay-1">
            ...
            <p className="service-description" style={{ minHeight: "auto", marginBottom: "20px" }}>
              Satu halaman website cocok untuk profil UMKM, Portofolio diri, Landing Page sederhana, dan lainya.
            </p>
            <ul className="pricing-features">
              ...
              <li className="pricing-feature-item">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12" /></svg>
                <span>Domain (my.id/web.id) 1 Tahun</span>
              </li>
              <li className="pricing-feature-item">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12" /></svg>
                <span>Hosting Unlimited</span>
              </li>
            </ul>
          ...
          <div className="service-card scroll-reveal reveal-delay-2">
            ...
            <p className="service-description" style={{ minHeight: "auto", marginBottom: "20px" }}>
              Cocok untuk Sistem POS Kasir, Profil Bisnis, Organisasi, Company Profile, dan lainya.
            </p>
            <ul className="pricing-features">
              <li className="pricing-feature-item">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12" /></svg>
          ...
          <div className="service-card scroll-reveal reveal-delay-3">
            ...
            <div className="pricing-header">
              ...
              <div className="pricing-price">
                <span className="pricing-amount">Rp 3,2 Juta</span>
              </div>
            </div>
            <p className="service-description" style={{ minHeight: "auto", marginBottom: "20px" }}>
              Website Toko Online, Transaksi Online, Manajemen Inventaris, dan lainya.
            </p>
            <ul className="pricing-features">
              <li className="pricing-feature-item">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12" /></svg>
          ...
          <div className="service-card service-card-highlight scroll-reveal reveal-delay-4">
            ...
            <h3 className="service-title" style={{ marginTop: "8px" }}>WEB CUSTOM</h3>
            <div className="pricing-header">
              <div className="pricing-price">
